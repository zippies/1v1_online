...
def index(stype='inline'):
	...
	friendslink = [
		{"alias":"生产环境1v1" ,"link":"http://10.10.15.78:7788/online"} if stype=='inline' else {"alias":"QA环境1v1" ,"link":"http://10.10.15.78:7788/inline"},
		{"alias":"监控系统","link":"http://10.10.15.78/monitor/show"}
	]
	navitems = [
